...
from bheem_core.modules.sales.core.models.sales_models import Quote, QuoteStatus, QuoteLineItem, Customer
from bheem_core.modules.sales.core.schemas.quote_schemas import (
...
class QuoteService:
    ...
    def create_quote(self, quote_data: QuoteCreate, current_user_id: UUID) -> Quote:
    ...
    def get_quote_by_id(self, quote_id: UUID, company_id: UUID) -> Optional[Quote]:
    ...
    def get_quote_by_number(self, quote_number: str, company_id: UUID) -> Optional[Quote]:
    ...
    def get_quote_items(self, quote_id: UUID) -> List[QuoteLineItem]:
    ...
    def get_quote_analytics(self, company_id: UUID) -> Dict[str, Any]:
