...
class QuoteLineItem(BaseModel):
    ...
    # SKU reference (unified sellable items)
    sku_id = Column(UUID(as_uuid=True), ForeignKey("public.sku.sku_id"), nullable=False)
    
    # Legacy fields for compatibility and reporting
...
class ProductBundleItem(BaseModel):
    ...
    sku_id = Column(UUID(as_uuid=True), ForeignKey("public.sku.sku_id"), nullable=False)  # Reference to centralized SKU
